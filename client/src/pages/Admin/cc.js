...
import {codeShema} from './validation/validCodePromo'
...
<div className="modal fade" tabIndex={-1} id="kt_modal_1">
  ...
  <div className="mb-10">
  <label className="form-label">pourcentage promo</label>
  <input
    type="number"
    className="form-control form-control-solid"
    name="pourcentage_promo" value={pourcentage_promo} onChange={(e) => setBourcentagePromo(e.target.value)} 
    // placeholder="name@example.com"
  />
  </div>
  <div className="mb-10">
  <label className="form-label">date expiratio</label>
  <input
    type="date"
    className="form-control form-control-white"
    name="date_expiration" value={date_expiration} onChange={(e) => setDateExpiration(e.target.value)} 
  />
      ...
      <div className="modal-footer">
        ...
        onClick={CodePromo} 
          ...
          className="btn btn-light btn btn-primary"
          data-bs-dismiss="modal"
        >
          save
        </button>
