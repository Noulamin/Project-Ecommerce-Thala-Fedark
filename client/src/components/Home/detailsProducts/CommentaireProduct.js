...
<form>
  ...
  <h1 className="block font-bold mb-2 text-gray-900 dark:text-white">Votre avis  : </h1>
  <div className="flex items-center">
    ...
    <h1 className="block font-bold mb-2 text-gray-900 dark:text-white">Votre Commentaire : </h1>
